...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "skidi-312722-5042d89a9866.json"
PROJECT = "skidi-312722" # change for your GCP project
REGION = "us-central1" # change for your GCP region (where your model is hosted)

### Streamlit code (works as a straigtht-forward script) ###
st.title("Welcome to SkiDi")
st.header("Identify Skin Disease!")
...
choose_model = st.sidebar.selectbox(
    ...
    ("Model 1 (7 skin disease classes)", # original 10 classes
...
# Model choice logic
if choose_model == "Model 1 (7 skin disease classes)":
